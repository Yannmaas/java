...
public class JIFStockVisiteur extends JInternalFrame  implements ActionListener 
{
    ...
    public JIFStockVisiteur()
    {
        ...
        {
            tableModel.addRow(new Object[]{premierVisiteur.get(i).getUnMedicament().getMed_depotlegal(), premierVisiteur.get(i).getUnMedicament().getMed_nomcommercial(), premierVisiteur.get(i).getQteStock()});
        }
    ...
    { 
        ...
        for (int i = 0; i < listeStock.size(); i++)
        {
            ...
            tableModel.addRow(new Object[]{leStock.getUnMedicament().getMed_depotlegal(), leStock.getUnMedicament().getMed_nomcommercial(), leStock.getQteStock()});
        }
    }
}